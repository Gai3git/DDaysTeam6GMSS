...
@Test(priority=11,description="TestCase verifies Country is a dropdownlist")
     public void TC_verifyCountryIsADropdownList() throws InterruptedException
     {
	   addressBook.clickAddNewShipToAddressLink();
...
@Test(priority=12,dependsOnMethods={"TC_verifyCountryIsADropdownList"},description="TestCase verifies Country's default value is United States of America.")
...
@Test(priority=14,dependsOnMethods={"TC_verifyCountryDropdownDefaultValue"},description="TestCase verifies Company Name displays alert msg for commercial with shipping docks.")
...
@Test(priority=15,dependsOnMethods={"TC_verifyCountryDropdownDefaultValue"},description="TestCase verifies Company Name displays alert msg  for  commercial  without shipping docks.")
